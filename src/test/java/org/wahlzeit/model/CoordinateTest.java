...
public class CoordinateTest {
    ...
    public void createCoordinate_withExcedingMaxValueInZ_shouldThroughException(){
        new Coordinate(1,1,VALUE_EXCEEDING_COORD_MAXVALUE);
    }

    @Test(expected = IllegalArgumentException.class)
    public void createCoordinate_withExcedingMaxValueInX_shouldThroughException(){
        new Coordinate(1,VALUE_EXCEEDING_COORD_MAXVALUE,1);
    }

    @Test(expected = IllegalArgumentException.class)
    public void createCoordinate_withExcedingMaxValueInY_shouldThroughIllegalArgumentException(){
    ...
    @Test
    public void createCoordinate_aboveCoordMinValue_shouldNOTThroughExeptions(){
        try{
            new Coordinate(1,1,-Coordinate.MAX_VALUE);
            new Coordinate(1,-Coordinate.MAX_VALUE,1);
            new Coordinate(-Coordinate.MAX_VALUE,1,1);
