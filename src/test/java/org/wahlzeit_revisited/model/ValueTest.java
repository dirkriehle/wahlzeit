...
public class ValueTest {
	...
	public void testPhotoStatus() {
		assert (org.wahlzeit.model.PhotoStatus.VISIBLE == org.wahlzeit.model.PhotoStatus.getFromInt(0));
		assert (org.wahlzeit.model.PhotoStatus.INVISIBLE == org.wahlzeit.model.PhotoStatus.getFromInt(1));
		assert (org.wahlzeit.model.PhotoStatus.FLAGGED2 == org.wahlzeit.model.PhotoStatus.getFromInt(3));
		assert (org.wahlzeit.model.PhotoStatus.MODERATED == org.wahlzeit.model.PhotoStatus.getFromInt(4));
		assert (org.wahlzeit.model.PhotoStatus.MODERATED3 == org.wahlzeit.model.PhotoStatus.getFromInt(6));

		org.wahlzeit.model.PhotoStatus ps = org.wahlzeit.model.PhotoStatus.VISIBLE;
		assert (ps.asInt() == 0);

		org.wahlzeit.model.PhotoStatus ps2 = ps.asInvisible(true);
		assert (ps != ps2);
		...
		org.wahlzeit.model.PhotoStatus ps3 = ps2.asFlagged(true);
		assert (ps2 != ps3);
		...
		org.wahlzeit.model.PhotoStatus ps3b = org.wahlzeit.model.PhotoStatus.FLAGGED;
		assert (ps3 != ps3b);
		...
		org.wahlzeit.model.PhotoStatus ps2b = ps3b.asInvisible(true);
		assert (ps2b != ps3b);
