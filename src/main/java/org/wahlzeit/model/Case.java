...
/**
 * A case is a user complaint, most notably about an inappropriate photo. Subclasses capture the specifics of different
 * types of cases; here only an id is provided.
 *
 * @author dirkriehle
 */
